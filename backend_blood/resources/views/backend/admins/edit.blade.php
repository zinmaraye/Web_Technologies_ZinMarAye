                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            <span><i class="fa fa-edit"></i> Edit Admin</span>
                        </div>
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.update', $admin->id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="phone" id="phone" class="form-control" value="{{ old('phone', $admin->phone) }}" required>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="admin_permission" id="admin_permission" class="form-control" required>
                                        <option value="1" {{ old('admin_permission', $admin->admin_permission) == 1 ? 'selected' : '' }}>Yes</option>
                                        <option value="0" {{ old('admin_permission', $admin->admin_permission) == 0 ? 'selected' : '' }}>No</option>
                                    </select>
                                </div>
